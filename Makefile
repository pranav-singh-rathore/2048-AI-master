#############################################################################
# Makefile for building: 2048_game.app/Contents/MacOS/2048_game
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  2048_game.pro
# Template: app
# Command: /opt/homebrew/bin/qmake6 -o Makefile 2048_game.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = 2048_game1.0.0
DISTDIR = /Users/pranavrathore/Downloads/2048-AI/2048-AI-master/.tmp/2048_game1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/macx.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/sanitize.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/gcc-base.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/gcc-base-mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/clang.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/clang-mac.conf \
		...
		2048_game.pro board.h \
		mainwindow.h board.cpp \
		main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = 2048_game
DESTDIR       = 
TARGET        = 2048_game.app/Contents/MacOS/2048_game

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/pranavrathore/Downloads/2048-AI/2048-AI-master/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/pranavrathore/Downloads/2048-AI/2048-AI-master/2048_game.pro


include /opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

2048_game.app/Contents/MacOS/2048_game: ui_mainwindow.h $(OBJECTS)  
	@test -d 2048_game.app/Contents/MacOS/ || mkdir -p 2048_game.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: 2048_game.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0_1/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile 2048_game.pro
...
2048_game.app/Contents/PkgInfo: 
	@test -d 2048_game.app/Contents || mkdir -p 2048_game.app/Contents
	@$(DEL_FILE) 2048_game.app/Contents/PkgInfo
	@echo "APPL????" > 2048_game.app/Contents/PkgInfo
2048_game.app/Contents/Info.plist: 
	@test -d 2048_game.app/Contents || mkdir -p 2048_game.app/Contents
	@$(DEL_FILE) 2048_game.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,PrimeShiftIT.2048-game,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},PrimeShiftIT.2048-game,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,2048_game,g" -e "s,@LIBRARY@,2048_game,g" -e "s,\$${EXECUTABLE_NAME},2048_game,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >2048_game.app/Contents/Info.plist

all: Makefile \
		2048_game.app/Contents/PkgInfo \
		2048_game.app/Contents/Info.plist 2048_game.app/Contents/MacOS/2048_game
...
distdir: FORCE
	...
	$(COPY_FILE) --parents board.h mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents board.cpp main.cpp mainwindow.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/pranavrathore/Downloads/2048-AI/2048-AI-master/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/pranavrathore/Downloads/2048-AI/2048-AI-master -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib mainwindow.h -o moc_mainwindow.cpp
